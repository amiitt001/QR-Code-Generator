    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="prose prose-indigo max-w-none text-gray-600 space-y-8">
        <section>
          ...
          <p>
            At Gemini QR Studio, accessible from our website, one of our main priorities is the privacy of our visitors. 
            This Privacy Policy document contains types of information that is collected and recorded by Gemini QR Studio and how we use it.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            <strong>Log Files:</strong> Like many other Web sites, Gemini QR Studio makes use of log files. 
        ...
        <section>
          ...
          <p>
            Gemini QR Studio uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. 
